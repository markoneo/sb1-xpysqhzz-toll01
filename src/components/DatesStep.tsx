...
export function DatesStep({ startDate, endDate, onChange }: DatesStepProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Travel Dates</h2>
        <p className="text-gray-600 mb-6">When are you planning to travel?</p>
      ...
      <div className="p-6 rounded-xl bg-amber-50 border-2 border-amber-200">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="font-semibold text-amber-900 mb-1">Tip</h3>
            <p className="text-sm text-amber-800">
              For vignette-based countries, we'll recommend the most cost-effective duration based on your trip length.
              Longer vignettes (1 month or 1 year) may be cheaper if you're planning multiple trips.
            </p>
          </div>
        </div>
      </div>
